...
import com.programmingmastery.database.test.TransactionalTest;
...
class UniquePersistableObjectTest extends TransactionalTest {
  ...
  void testCommonFields() {
    ...
    assertThat(neven)
        .hasToString(
            "{id: \"bcf5dd8f-6bab-4a6d-8728-a2f0e26c272c\", version: 1, class: \"com.programmingmastery.database.jpa.UniquePersistable\"}");
